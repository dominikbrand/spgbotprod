...
import Azure from "../../assets/spglogo.svg";
                ...
                <Stack horizontal className={styles.chatRoot}>
                                ...
                                {showLoadingMessage && (
                                    <>
                                        <div className={styles.chatMessageGpt}>
                                            <Answer
                                                answer={{
                                                    answer: "Bitte hab einen Moment Geduld, ich durchsuche alle Dokumente und generiere eine Antwort...",
                                                    citations: []
                                                }}
                    ...
                    <Stack.Item className={styles.citationPanel} tabIndex={0} role="tabpanel" aria-label="Citations Panel">
                        <Stack aria-label="Citations Panel Header Container" horizontal className={styles.citationPanelHeaderContainer} horizontalAlign="space-between" verticalAlign="center">
                            <span aria-label="Citations" className={styles.citationPanelHeader}>Referenz Details (Klick auf nachfolgenden Titel und das Original Dokument anzuzeigen)</span>
